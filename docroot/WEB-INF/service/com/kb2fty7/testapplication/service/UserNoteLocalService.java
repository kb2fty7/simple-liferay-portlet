...
/**
 * Provides the local service interface for UserNote. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Р®СЂРёР№
 * @see UserNoteLocalServiceUtil
...
public interface UserNoteLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserNoteLocalServiceUtil} to access the user note local service. Add custom service methods to {@link com.kb2fty7.testapplication.service.impl.UserNoteLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
